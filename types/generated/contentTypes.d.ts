...
export interface ApiOfferOffer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    offer_details: Attribute.Relation<
      'api::offer.offer',
      'oneToMany',
      'api::offer-detail.offer-detail'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiOfferDetailOfferDetail extends Schema.CollectionType {
  collectionName: 'offer_details';
  info: {
    singularName: 'offer-detail';
    pluralName: 'offer-details';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::offer-detail.offer-detail': ApiOfferDetailOfferDetail;
